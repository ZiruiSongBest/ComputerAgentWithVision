...
class SeeClick:
    def __init__(self, screen_helper: ScreenHelper, url: str = 'http://localhost:8998/seeclick', prompt_template: str = "In this UI screenshot, what is the position of the element corresponding to the command \"{}\" (with point)?"):
        self.url = url
