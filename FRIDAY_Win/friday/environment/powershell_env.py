...
import sys
sys.path.append(r'C:\Users\dylan\Desktop\ComputerAgentWithVision\FRIDAY_Win')
...
if __name__ == '__main__':
    env = CmdEnv()
    print(env.name)
    # print(env.observe(r'C:\Users\dylan\Desktop\ComputerAgentWithVision\FRIDAY_Win'))
    # print(env.step("dir"))
    # print(env.step("cd ../../"))
    # print(env.step("gogo"))
    # env.reset()
