...
refs = [
        ...
        'click the search button', # the magnifier
        'click first video',
        'the polar bear image?'
        ]
files_paths = [
                '/Users/dylan/Desktop/1Res/osc/ComputerAgentWithVision/SeeClick/assets/ytb_video1.png',
                '/Users/dylan/Desktop/1Res/osc/ComputerAgentWithVision/SeeClick/assets/ytb_video2.png',
                '/Users/dylan/Desktop/1Res/osc/ComputerAgentWithVision/SeeClick/assets/ytb_video3.png',
                '/Users/dylan/Desktop/1Res/osc/ComputerAgentWithVision/SeeClick/assets/ytb_video4.png'
               ]

url = 'http://100.119.14.85:8998/upload'

for ref, img_path in zip(refs, files_paths):
